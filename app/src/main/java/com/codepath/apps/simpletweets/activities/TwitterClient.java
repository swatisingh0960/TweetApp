...
public class TwitterClient extends OAuthBaseClient {
    ...
    public static final String REST_CONSUMER_KEY = "rMzS2LG5djN66c56TY8CxTOkd"; // Change this
    public static final String REST_CONSUMER_SECRET = "aSwDbeqjSxUNGAWIbgm7J1a7MpcLxm04IOaYGz0okXADE0oD84";// Change this
